...
public class Phase1Tests {
  ...
  public void setUp() {
    ...
    parser = new Parser("ParsingTable.csv", "GrammarRules");
  ...
  public void ex1() {
    ...
    compareFileToMessage("./tests/ex1.tree", parser.printTree());
  }
  ...
  public void ex2() {
    ...
    compareFileToMessage("./tests/ex2.tree", parser.printTree());
  }
  ...
  public void ex3() {
    ...
    compareFileToMessage("./tests/ex3.tree", parser.printTree());
  }
  ...
  public void ex4() {
    ...
    compareFileToMessage("./tests/ex4.tree", parser.printTree());
  }
  ...
  public void ex5() {
    ...
    compareFileToMessage("./tests/ex5.tree", parser.printTree());
  }
  ...
  public void ex6() {
    ...
    compareFileToMessage("./tests/ex6.tree", parser.printTree());
  }
  ...
  public void ex7() {
    ...
    compareFileToMessage("./tests/ex7.tree", parser.printTree());
  }
  ...
  public void ex8() {
    ...
    compareFileToMessage("./tests/ex8.tree", parser.printTree());
  }
